...
import 'package:nowlive/tvpages/tvchannels.dart';
import 'package:nowlive/tvpages/tvrentstore.dart';
...
import 'package:nowlive/model/sectionlistmodel.dart';
import 'package:nowlive/model/sectiontypemodel.dart' as type;
import 'package:nowlive/model/sectionlistmodel.dart' as list;
import 'package:nowlive/model/sectionbannermodel.dart' as banner;
import 'package:nowlive/utils/constant.dart';
import 'package:nowlive/utils/dimens.dart';
import 'package:nowlive/tvpages/tvvideosbyid.dart';
...
import 'package:nowlive/webwidget/searchweb.dart';
...
class TVHomeState extends State<TVHome> {
  ...
  String? currentPage, langCatName, mSearchText;
   ...
   String downloadAppText = "DOWNLOAD APP";
    ...
    return Container(
      ...
      child: Row(
        ...
        children: [
          ...
          Material(
            ...
            child: InkWell(
              ...
              child: Container(
                ...
                child: MyImage(width: 68, height: 98, imagePath: "Ngreen.png"),
              ),
            ),
          ),
          ...
          // Define the text using a variable

Material(
  type: MaterialType.transparency,
  child: InkWell(
    onTap: () async {
      const url = 'https://drive.google.com/file/d/1Y5xKdG3bpTfuDbiNqVYt8-3tNeEWnnDW/view?usp=drive_link';
    ...
    child: Container(
      ...
      child: MyText(
        color: white,
        multilanguage: true,
        text: downloadAppText, // Use the variable here
        fontsizeNormal: 14,
        fontweight: FontWeight.w600,
        fontsizeWeb: 14,
        maxline: 1,
